...
import utils
from utils import get_grad_norm_
...
def get_model(args, **kwargs):
    ...
    '''
    create_model function from the timm.models module in the tim library allows us to easily 
    create and initialize pre-defined models

    args.model is vqnsp_encoder_base_decoder_3x200x12, which stands for 
    vector Quantization Neural Spectral Prediction. This architecture is defined in the 
    modeling_vqnsp.py file.
...
def main(args):
    ...
    # datasets_train = [
    #     ["savedata/dataset_train.hdf5"], # e.g., 32 channels for dataset3 and dataset4
    # ]

    # datasets_train = [
    #     ["savedata/bciiv2b_raw.hdf5"], # e.g., 32 channels for dataset3 and dataset4
    # ]

    datasets_train = [
        ["savedata/dataset_tuev.hdf5"], # e.g., 32 channels for dataset3 and dataset4
    ]

    # datasets_train = [
    #     ["Data/savedata/dataset_tr.hdf5"], # e.g., 32 channels for dataset3 and dataset4
    # ]
    ...
    time_window = [
        4, # set the time window to 8 so that the sequence length is 8 * 32 = 256
    ]
    dataset_train_list, train_ch_names_list = utils.build_pretraining_dataset(datasets_train, time_window, stride_size=200)

    # datasets_val = [
    #     ["savedata/dataset_train.hdf5"]
    # ]

    # datasets_val = [
    #     ["savedata/bciiv2b_raw.hdf5"]
    # ]

    datasets_val = [
        ["savedata/dataset_tuev.hdf5"]
    ]
