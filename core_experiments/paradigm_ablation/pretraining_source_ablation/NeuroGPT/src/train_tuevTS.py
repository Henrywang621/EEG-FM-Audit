...
from batcher.downstream_dataset import TUEVDataset # <-- CHANGED: Imported TUEVDataset
...
def run_single_seed_training(config, seed):
    ...
    # <-- CHANGED: Updated target path and TUEV folder structure
    ...
    # <-- CHANGED: Swapped TUABDataset for TUEVDataset
    ...
    # Note: verify that your 'make_trainer' accepts report_to if using standard HF Trainer
...
def get_args():
    ...
    # <-- CHANGED: Default dataset path updated
    parser.add_argument('--dst-data-path', default="/homes/xw2336/data_portal/TUEV/processed", type=str)
    parser.add_argument('--pretrained-model', type=str, 
                        default='/homes/xw2336/data_portal/LLM_eva_fast/NeuroGPT/pretrained_model/model_tuev.safetensors')
    ...
    # <-- CHANGED: Default num classes changed from 2 to 6 for TUEV
